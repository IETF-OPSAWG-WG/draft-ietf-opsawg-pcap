...
: ESP Security Association keys.
  ...
  describe an ESP security association. As of today, each line has the following
  columns: "Protocol","Src IP","Dest IP","SPI","Encryption","Encryption Key",
  ...
  If the line contains less columns than what is expected by the reader, it should either apply a default
