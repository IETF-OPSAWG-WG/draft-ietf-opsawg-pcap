...
0x45535053:
: ESP SAs UAT.
  This format uses a CSV file with strings describing an ESP security association
  per line. As of today, each line has the following columns: "Protocol","Src IP",
  "Dest IP","SPI","Encryption","Encryption Key","Authentication","Authentication Key",
  "SN","ESN High Bits". All columns must be filled with a value.
